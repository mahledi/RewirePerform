...
const ADDITIONAL_DAY_INPUTS: ProgramDayInput[] = [
  ...
  },
  {
    ...
    science: [
      "Wenn du ständig darüber nachdenkst, wie du wirkst, bleibt weniger Aufmerksamkeit für deine Aufgabe.",
      "Ein konkreter Beitrag gibt deiner Aufmerksamkeit wieder eine klare Richtung.",
      "Du beschäftigst dich weniger mit deinem Bild und mehr mit dem, was du jetzt wirklich beitragen kannst.",
    ],
    mission: {
      title: "Mach deinen Beitrag sichtbar",
      trigger: "Wenn du dich stark mit deiner Wirkung, Bewertung oder Position beschäftigst.",
      steps: [
        "Frag dich: Was wird gerade von mir gebraucht?",
        "Wähle einen konkreten Beitrag.",
        "Zeig ihn in deiner nächsten Handlung.",
      ],
  ...
  },
  {
    ...
    toolId: "W4",
    stage: "Vertiefung",
    title: "Trenne, was feststeht, von deinem nächsten Schritt",
    purpose: "Du hältst fest, was passiert ist, bemerkst festhaltende Gedanken und findest, was du noch tun kannst.",
    science: [
      "Was passiert ist und was du jetzt tun kannst, sind zwei verschiedene Dinge.",
      "Nach einem frustrierenden Moment kann dein Kopf immer wieder fordern, dass es anders hätte laufen müssen. Dadurch bleibt weniger Aufmerksamkeit für das, was noch bei dir liegt.",
      "Du musst den Frust nicht wegmachen. Halte kurz fest, was passiert ist, und suche danach genau eine Sache, die du noch beeinflussen kannst.",
    ],
    mission: {
      title: "Festhalten und weiterhandeln",
      trigger: "Wenn du dich über etwas ärgerst, das du nicht mehr ändern kannst.",
      steps: [
        "Beschreibe kurz, was wirklich passiert ist.",
        "Merk, welche Gedanken dich weiter daran festhalten.",
        "Frag: Was kann ich jetzt beeinflussen? Nutze genau eine Antwort.",
      ],
      why: "Du trennst das Unveränderbare von der Handlung, die weiterhin bei dir liegt.",
    },
    check: {
      prompt: "Welche Aussage beschreibt nur, was wirklich passiert ist?",
      ...
      feedback: "Richtig. Die Aussage hält nur fest, was passiert ist. Die anderen Sätze fordern weiter eine andere Vergangenheit.",
    },
    recall: {
      prompt: "Welche Frage bringt dich von dem, was feststeht, zurück zu deiner nächsten Handlung?",
      application: "Nutze die Antwort für genau eine Handlung, die du weiterhin beeinflussen kannst.",
    },
    journal: {
      title: "Was stand fest, was blieb möglich?",
      intro: "Geh eine konkrete Situation durch und trenne, was passiert ist, von dem, was du noch tun konntest.",
      questions: [
        { prompt: "Was war wirklich passiert?", placeholder: "Ein kurzer Satz ohne Bewertung." },
        { prompt: "Welche Gedanken haben dich weiter daran festgehalten?", placeholder: "Was hat dein Kopf immer wieder gefordert?" },
  ...
  },
  {
    ...
    science: [
      ...
      "Ein Fehler, Müdigkeit und zusätzlicher Druck kommen zusammen. Dann nimmt dein Kopf vor allem wahr, was noch schlechter läuft.",
      "Dinge, die funktionieren oder dir helfen könnten, geraten leichter aus dem Blick.",
    ],
    mission: {
      title: "Hol das ganze Bild zurück",
      trigger: "Wenn mehrere Belastungen deinen Blick zunehmend eng und deine Handlung unklar machen.",
      steps: [
        "Benenne kurz, was gerade zusammenkommt.",
        "Finde etwas, das weiterhin funktioniert oder dir hilft.",
        "Wähle daraus eine kleine nächste Handlung.",
      ],
