        ...
        <div className="space-y-8 text-sm leading-relaxed text-muted-foreground">
          ...
          <section className="rounded-2xl border border-primary/20 bg-primary/5 p-5">
            ...
            <ul className="space-y-2">
              ...
              {feedbackEnabled ? (
                <li><span className="text-foreground">Feedback Intelligence ist freiwillig und klar getrennt.</span> An Tag 10, 24, 39 und 55 kannst du überspringbare Auswahlfragen beantworten. Jarvis darf dafür nur pseudonymisierte Auswahlantworten und minimierte Aktivitätszahlen kurzzeitig im Arbeitsspeicher verarbeiten. Ausgegeben werden ausschließlich Gruppenzusammenfassungen pro Frage ab mindestens fünf unterschiedlichen Teilnehmenden; die pseudonymen Referenzen werden weder ausgegeben noch dauerhaft gespeichert. Freitexte erhält Jarvis nicht und die Daten werden nicht zum Trainieren eines KI-Modells verwendet. Einen klar als Produktfeedback markierten Kommentar verarbeitet RewirePerform nur nach deiner zusätzlichen ausdrücklichen Einwilligung; dein Nein hat keinen Nachteil.</li>
              ) : (
