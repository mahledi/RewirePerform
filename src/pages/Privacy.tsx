        ...
        <div className="space-y-8 text-sm leading-relaxed text-muted-foreground">
          ...
          <section className="rounded-2xl border border-primary/20 bg-primary/5 p-5">
            ...
            <ul className="space-y-2">
              ...
              {feedbackEnabled ? (
                <li><span className="text-foreground">Feedback Intelligence ist freiwillig und klar getrennt.</span> Für Tag 10, 24, 39 und 55 kannst du überspringbare Auswahlfragen beantworten. Verpasst du einen dieser Zeitpunkte, kann dir der älteste noch offene Zwischenstand beim nächsten späteren Login erneut angeboten werden. Du kannst ihn später erinnern lassen oder für diesen Zeitpunkt entscheiden, kein Feedback zu geben. Jarvis darf dafür nur pseudonymisierte Auswahlantworten und minimierte Aktivitätszahlen kurzzeitig im Arbeitsspeicher verarbeiten. Ausgegeben werden ausschließlich Gruppenzusammenfassungen pro Frage ab mindestens fünf unterschiedlichen Teilnehmenden; die pseudonymen Referenzen werden weder ausgegeben noch dauerhaft gespeichert. Freitexte erhält Jarvis nicht und die Daten werden nicht zum Trainieren eines KI-Modells verwendet. Einen klar als Produktfeedback markierten Kommentar verarbeitet RewirePerform nur nach deiner zusätzlichen ausdrücklichen Einwilligung; dein Nein hat keinen Nachteil.</li>
              ) : (
          ...
          <section>
            ...
            <p className="mt-3">
              {feedbackEnabled
                ? "Ausdrücklich freigegebene Produktfeedback-Kommentare sind ausschließlich in einer geschützten, pseudonymisierten und nur lesenden Admin-Ansicht zugänglich. Das intern und lokal betriebene Jarvis-System darf ausschließlich pseudonymisierte Auswahlantworten und minimierte Aktivitätszahlen kurzzeitig im Arbeitsspeicher verarbeiten, um Gruppenzusammenfassungen pro Frage ab fünf unterschiedlichen Teilnehmenden zu bilden. Die pseudonymen Referenzen werden weder im Ergebnis ausgegeben noch dauerhaft gespeichert. Jarvis erhält keine Produktfeedback-Kommentare. Namen, E-Mail-Adressen und direkte Nutzerkennungen bleiben ausgeschlossen. Journale, private Reflexionen, Supporttexte sowie Team- und Coach-IDs bleiben ausgeschlossen. Die Daten werden nicht zum Trainieren eines KI-Modells und nicht für automatisierte Einzelentscheidungen verwendet."
