      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-sm leading-relaxed text-muted-foreground">
          ...
          <section>
            ...
            <p className="mt-3">
              {feedbackEnabled
                ? "Jarvis ist ein intern betriebenes System von RewirePerform und kein externer Empfänger. Es darf ausschließlich ausdrücklich freigegebene Produktfeedback-Kommentare gemeinsam mit den zugehörigen Auswahlantworten und minimierten Aktivitätszahlen lesen. Im Analyseexport stehen weder Name noch E-Mail-Adresse. Journale, private Reflexionen, Supporttexte, Team- und Coach-Daten bleiben ausgeschlossen."
